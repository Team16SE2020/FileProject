...
<title> CTM INDUSTRY[AREA UTENTE]</title>
<?php session_start();
?>
<head>		
...
<?php
	...
	{
		$contatore = trim(file_get_contents($filename));
	}
	else 
	{ 
		$contatore = 0; 
	}
	if(!isset($_SESSION['visitato1']))
	{ 	
		
		$contatore++;
		$_SESSION['visitato1']="si";  
		$file = fopen( $filename,"w");
		fwrite( $file, $contatore); 
		fclose( $file );
	}
?> 	
...
<body>
<div class="container">	
     <?php echo "<p style='font-size:15pt'>Totale accessi: $contatore</p>" ;?>
	<br/>
</div>
</body>
</html>
