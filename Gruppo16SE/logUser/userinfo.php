...
?>
		...
		<button class="button" onclick="window.location.href = 'loginSystem.php';" style="vertical-align:middle"><span>System Administrator</span></button>
		<button class="button" onclick="window.location.href = 'loginPlanner.php';" style="vertical-align:middle"><span>Planner</span></button>
		<button class="button" onclick="window.location.href = 'loginRepository.php';" style="vertical-align:middle"><span>Repository Manager</span></button>
		<button class="button" onclick="window.location.href = 'loginMaintainer.php';" style="vertical-align:middle"><span>Maintainer</span></button>
	</html>
