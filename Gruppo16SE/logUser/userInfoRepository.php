...
?>
		...
		<button class="button" onclick="window.location.href = 'showfiliali.php';" style="vertical-align:middle"><span>Accesso alle filiali</span></button>
		<button class="button" onclick="window.location.href = 'newsede.php';" style="vertical-align:middle"><span>Inserisci una nuova sede</span></button>
		<button class="button" onclick="window.location.href = 'manageproc.php';" style="vertical-align:middle"><span>Inserisci procedure di manutenzione</span></button>
		<button class="button" onclick="window.location.href = 'showproc.php';" style="vertical-align:middle"><span>Gestisci procedure di manutenzione</span></button>
